/* ---------- Tema ---------- */
  ...
  const translations = {
    no: {
      ...
      s2_lede:            'Når PokeDecks åpner, legger vi ut en ny giveaway bod på markedsplassen hver dag kl. 18 gjennom launchuken.<br><br>Giveaway bodene ligger inne på PokeDecks som egne boder. Du går inn på boden, ser premien og trykker “Delta” for å melde deg på.',
      ...
      s2_asset_title:     'Giveaway-artikler kommer her',
      s2_asset_desc:      'Klar bildeflate for premier når launch assets er klare.',
      s2_cta:             'Varsle meg når launchuken starter',
      s3_kicker:          'Slik fungerer det',
      s3_headline:        'Delta direkte på PokeDecks',
      s3_lede:            'Giveawayene skjer inne på PokeDecks. Når en giveaway bod er aktiv, trykker du “Delta” på boden.',
      s3_step1:           'Gå inn på dagens giveaway bod',
      s3_step2:           'Trykk “Delta”',
      s3_step3:           'Logg inn med Vipps hvis du ikke allerede er innlogget',
      s3_step4:           'Du er med i trekningen',
      s3_cta:             'Få beskjed når vi åpner',
      ...
      s4_card3:           'Fastpris og auksjoner',
      s4_card4:           'Tydelig tilstand, bilder og pris',
      s4_card5:           'Tryggere flyt mellom kjøper og selger',
      s4_cta:             'Hold meg oppdatert',
      s5_kicker:          'For kjøpere',
      s5_headline:        'Finn kort, følg boder og oppdag auksjoner',
      s5_lede:            'PokeDecks skal gjøre det enklere å finne interessante kort og produkter fra norske samlere.<br><br>Du kan bla gjennom salgsboder, se bilder og tilstand, følge med på auksjoner og sende forespørsel når du finner noe du vil kjøpe.',
      s5_card1:           'Se flere produkter samlet i én salgsbod',
      s5_card2:           'Følg auksjoner og budhistorikk',
      s5_card3:           'Send kjøpsforespørsel når du finner noe interessant',
      s5_card4:           'Se tydelig informasjon før du går videre',
      s5_card5:           'Handle med norske samlere',
      s5_cta:             'Få launch varsel',
      s6_kicker:          'For selgere',
      s6_headline:        'Åpne salgsbod og vis frem kortene dine',
      s6_lede:            'Har du Pokémon kort du vurderer å selge? På PokeDecks kan du samle produkter i en salgsbod i stedet for å lage mange små enkeltannonser.<br><br>Målet er å gjøre det enklere å presentere kortene dine ryddig, enten du selger ett produkt, flere kort eller vil teste auksjon.',
      s6_card1:           'Lag salgsbod med bilder og beskrivelser',
      s6_card2:           'Selg til fastpris',
      s6_card3:           'Bruk auksjon når det passer',
      s6_card4:           'Godkjenn kjøpsforespørsler før kontaktinfo deles',
      s6_card5:           'Få en ryddigere oversikt over egne salg',
      s6_cta:             'Bli varslet før launch',
      s7_kicker:          'Auksjon',
      s7_headline:        'Følg budrunder direkte på PokeDecks',
      s7_lede:            'Auksjoner gjør det mulig å legge ut kort og produkter med startpris, sluttid og tydelig budhistorikk.<br><br>Målet er at både kjøper og selger skal ha en ryddig oversikt over hva som skjer, hvem som leder og når auksjonen avsluttes.',
      s7_card1:           'Startpris og sluttid',
      s7_card2:           'Budhistorikk',
      s7_card3:           'Tydelig nedtelling',
      s7_card4:           'Mulighet for minstepris',
      s7_card5:           'Antisnipe for mer rettferdige avslutninger',
      s7_cta:             'Varsle meg ved launch',
      s8_kicker:          'Bli med fra starten',
      s8_headline:        'Vi bygger PokeDecks sammen med miljøet',
      s8_lede:            'PokeDecks bygges for norske Pokémon samlere, og vi ønsker å få med de første brukerne tidlig.<br><br>Ved å melde deg på listen får du beskjed når vi åpner, og du kan være blant de første som tester markedsplassen, salgsboder og launch giveaways.',
      s8_card1:           'Få beskjed når PokeDecks åpner',
      s8_card2:           'Se launch giveaways først',
      s8_card3:           'Test markedsplassen tidlig',
      s8_card4:           'Gi innspill før plattformen videreutvikles',
      s8_card5:           'Bli en del av starten på PokeDecks',
      s8_cta:             'Bli med fra starten',
      s9_kicker:          'Launch varsel',
      s9_headline:        'Få beskjed når PokeDecks åpner',
      s9_lede:            'Legg igjen e-postadressen din, så sender vi deg beskjed når PokeDecks åpner.<br><br>I launchuken legger vi ut en ny giveaway bod på markedsplassen hver dag kl. 18.',
      s9_btn:             'Få launch varsel',
      s9_note:            'Dette er kun påmelding til launch varsel. For å delta i giveaway må du melde deg på giveaway boden inne på PokeDecks når den er aktiv.',
      s9_micro:           'Vi sender kun viktig informasjon om lanseringen. Ingen vanlig nyhetsbrev eller spam.',
      s10_headline:       'Spørsmål og svar',
      s10_q1:             'Er jeg påmeldt giveaway når jeg legger igjen e-post?',
      s10_a1:             'Nei. E-postpåmelding gir deg 1 til 3 launch varsel. For å delta i giveaway må du gå inn på PokeDecks og melde deg på den aktuelle giveaway boden når den er aktiv.',
      s10_q2:             'Når legges giveawayene ut?',
      s10_a2:             'I launchuken legger vi ut en ny giveaway bod hver dag kl. 18.',
      s10_q3:             'Må jeg ha bruker for å delta?',
      s10_a3:             'Ja. For å delta må du være innlogget på PokeDecks. Innlogging skjer med Vipps når dette er klart.',
      s10_q4:             'Hvorfor må jeg logge inn?',
      s10_a4:             'Vi bruker innlogging for å registrere én påmelding per bruker og for å kunne kontakte vinneren på en ryddig måte.',
      s10_q5:             'Hva er en giveaway bod?',
      s10_a5:             'En giveaway bod er en egen bod på PokeDecks der du kan se premien og melde deg på trekningen. Den ligner på en vanlig salgsbod, men du kjøper ikke produktet. Du trykker “Delta” for å være med.',
      s11_kicker:         'Trygghet',
      s11_headline:       'Personvern og kontakt',
      s11_lede:           'Vi bruker e-postadressen din til å sende deg informasjon om lanseringen av PokeDecks.<br><br>Vi sender ikke vanlig nyhetsbrev uten samtykke, og du kan be oss slette e-postadressen din.',
      s11_card_privacy:   'Du kan be om sletting eller innsyn når som helst.',
      s11_contact:        'Har du spørsmål? Kontakt oss på',
      s11_disclaimer:     'Giveaways er ikke sponset, administrert eller knyttet til Meta, Instagram, Facebook, Nintendo eller The Pokémon Company.',
