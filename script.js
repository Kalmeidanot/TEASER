/* ---------- Tema ---------- */
  ...
  const translations = {
    ...
    en: {
      ...
      s1_kicker:          'Coming soon',
      s1_headline:        'PokeDecks is opening soon',
      s1_lede:            'A new Norwegian marketplace for Pokémon cards, built for collectors who want to buy, sell and follow auctions in a cleaner way.<br><br>Join the list and we will let you know when PokeDecks opens.',
      s1_btn:             'Get launch alert',
      s1_note:            'Email signup only gives you a launch alert. Giveaway entry happens inside PokeDecks when the giveaway booth is active.',
      spam:               'No spam. We promise.',
      ok_msg:             '<strong>Thanks! You will hear from us.</strong>',
      scroll_cue:         'Scroll',
      notice_label:       'Important',
      s2_kicker:          'Launch week',
      s2_headline:        'A new giveaway booth every day at 18:00',
      s2_lede:            'When PokeDecks opens, we will add a new giveaway booth to the marketplace every day at 18:00 throughout launch week. All giveaways will be drawn together 14 days after the first giveaway day.<br><br>The giveaway booths will appear inside PokeDecks as their own booths. Open the booth, view the prize and press “Join” to enter.',
      s2_notice:          'Email signup on this page means you will be notified when PokeDecks opens. You are not automatically entered into a giveaway. To participate, you must enter the active giveaway booth inside PokeDecks.',
      s2_cta:             'Notify me when launch week starts',
      s4_kicker:          'The marketplace',
      s4_headline:        'Built for Pokémon collectors in Norway',
      s4_lede:            'PokeDecks is a Norwegian marketplace for Pokémon cards and collectors.<br><br>Instead of filling the marketplace with one listing per card, we build around seller booths. A seller can collect multiple products in one booth, and buyers can browse the selection in a cleaner way.',
      s4_card1:           'Buy and sell Pokémon cards',
      s4_card2:           'Seller booths with multiple products in one place',
      s4_card3:           'Fixed price, auctions and other sale types',
      s4_card4:           'Clear condition, images and price',
      s4_card5:           'A safer flow between buyer and seller',
      s4_cta:             'Keep me updated',
      s5_kicker:          'For buyers and sellers',
      s5_headline:        'A cleaner flow for both sides of the trade',
      s5_lede:            'PokeDecks is built to make it easier to find interesting cards, present your own products and keep track of purchases, sales and requests.',
      s5_buyers_title:    'For buyers',
      s5_buyers_copy:     'Browse seller booths, view images and condition, follow auctions and send a purchase request when you find something interesting.',
      s5_buyers_card1:    'See multiple products in one seller booth',
      s5_buyers_card2:    'Follow auctions and bid history',
      s5_buyers_card3:    'Send purchase requests',
      s5_buyers_card4:    'Trade with Norwegian collectors',
      s5_sellers_title:   'For sellers',
      s5_sellers_copy:    'Collect cards and products in a seller booth, choose fixed price or auction, and approve requests before contact information is shared.',
      s5_sellers_card1:   'Create a seller booth with images and descriptions',
      s5_sellers_card2:   'Sell at a fixed price',
      s5_sellers_card3:   'Use auctions when it makes sense',
      s5_sellers_card4:   'Approve requests before contact info is shared',
      s5_cta:             'Get launch alert',
      s6_kicker:          'Auction',
      s6_headline:        'Follow bidding rounds directly on PokeDecks',
      s6_lede:            'Auctions make it possible to list cards and products with a starting price, end time and clear bid history.<br><br>The goal is to give both buyer and seller a clean overview of what is happening, who is leading and when the auction ends.',
      s6_card1:           'Starting price and end time',
      s6_card2:           'Bid history',
      s6_card3:           'Clear countdown',
      s6_card4:           'Optional minimum price',
      s6_card5:           'Anti snipe for fairer endings',
      s6_cta:             'Notify me at launch',
      s7_kicker:          'Join from the start',
      s7_headline:        'Get notified when PokeDecks opens',
      s7_lede:            'PokeDecks is being built for Norwegian Pokémon collectors, and we want to bring the first users in early.<br><br>By joining the list, you will be notified when we open, and you can be among the first to test the marketplace, seller booths and launch giveaways.<br><br>During launch week, we will add a new giveaway booth to the marketplace every day at 18:00.',
      s7_btn:             'Get launch alert',
      s7_note:            'This is only signup for a launch alert. To enter a giveaway, you must join the giveaway booth inside PokeDecks when it is active.',
      s7_micro:           'We only send important launch information. No regular newsletter or spam.',
      s8_kicker:          'Trust',
      s8_headline:        'Questions, privacy and contact',
      s8_q1:              'Am I entered into a giveaway when I leave my email?',
      s8_a1:              'No. Email signup gives you 1 to 3 launch alerts. To enter a giveaway, you must go to PokeDecks and join the active giveaway booth when it is available.',
      s8_q2:              'When are the giveaways posted?',
      s8_a2:              'During launch week, we will add a new giveaway booth every day at 18:00.',
      s8_q3:              'Do I need an account to enter?',
      s8_a3:              'Yes. To enter, you must be signed in to PokeDecks. Login will use Vipps when this is ready.',
      s8_q4:              'What is a giveaway booth?',
      s8_a4:              'A giveaway booth is its own booth on PokeDecks where you can view the prize and enter the draw. It looks similar to a normal seller booth, but you do not buy the product. You press “Join” to enter.',
      s8_trust1:          'We use your email address to send you information about the launch of PokeDecks.',
      s8_trust2:          'We do not send a regular newsletter without consent, and you can ask us to delete your email address.',
      s8_contact:         'Questions? Contact us at',
      s8_disclaimer:      'Giveaways are not sponsored, administered by or associated with Meta, Instagram, Facebook, Nintendo or The Pokémon Company.',
